                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <select name="mapel" id="mapel" class="form-control">
                            <option value="SOSIOLOGI" <?php if ($mapel == 'SOSIOLOGI') echo "selected"; ?>>SOSIOLOGI</option>
                            <option value="EKONOMI" <?php if ($mapel == 'EKONOMI') echo "selected"; ?>>EKONOMI</option>
                            <option value="GEOGRAFI" <?php if ($mapel == 'GEOGRAFI') echo "selected"; ?>>GEOGRAFI</option>
                            <option value="FISIKA" <?php if ($mapel == 'FISIKA') echo "selected"; ?>>FISIKA</option>
                            <option value="KIMIA" <?php if ($mapel == 'KIMIA') echo "selected"; ?>>KIMIA</option>
                            <option value="BIOLOGI" <?php if ($mapel == 'BIOLOGI') echo "selected"; ?>>BIOLOGI</option>
                        </select>
