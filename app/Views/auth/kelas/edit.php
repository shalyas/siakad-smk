...
<div class="modal fade" id="modaledit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <?= form_open('siswa/updatekelas', ['class' => 'formedit']) ?>
            <?= csrf_field(); ?>
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="nama_kelas" value="<?= $nama_kelas ?>" name="nama_kelas">
                    ...
                    <div class="col-sm-8">
                        <select name="guru_id" id="guru_id" class="js-example-basic-single">
                            <?php foreach ($guru as $key => $data) { ?>
                                <option value="<?= $data['guru_id'] ?>" <?php if ($data['guru_id'] == $guru_id) echo "selected"; ?>><?= $data['nama'] ?></option>
                            <?php } ?>
                        </select>
